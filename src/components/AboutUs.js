      ...
      <section className="container mx-auto p-6 flex flex-col lg:flex-row gap-8 items-center">
        ...
        <div className="lg:w-1/2">
          ...
          <p className="text-gray-700 mb-6 text-sm md:text-base text-center lg:text-left">
            Welcome to STAR BLOOM LANDSCAPING & AGRICULTURAL SERVICES, SP
            LLC,Established in 2019, your trusted partner in the export of
            premium quality trees and other plants from Thailand to various
            parts of the world. With a focus on Dubai, Qatar, Saudi Arabia,
            Kuwait, Oman, and Bahrain, we have established ourselves as a
            leading provider of a diverse range of horticultural products,
            ensuring exceptional quality and service.
          </p>
          ...
          <div className="p-4 border border-gray-200 rounded-md text-sm md:text-base">
            {activeTab === "mission" && (
              <p className="text-gray-700">
                Welcome to Welcome to STAR BLOOM LANDSCAPING & AGRICULTURAL
                SERVICES, SP LLC,Established in 2019,, your trusted partner in
                the export of premium quality trees and plants from Thailand to
            ...
            {activeTab === "expertise" && (
              <p className="text-gray-700">
                ...
                specialize in exporting a wide variety of plants, including
                trees, palms, shrubs, and succulents...
              </p>
            )}
            {activeTab === "quality" && (
              <p className="text-gray-700">
                Quality is at the heart of everything we do. We adhere to
                stringent biosecurity protocols to ensure pest-free,
                disease-free plants...
              </p>
            )}
          </div>
        ...
        <div className="w-full sm:w-3/4 md:w-2/3 lg:w-1/2 mx-auto p-4 border border-gray-200 rounded-md text-sm md:text-base text-center">
          {activeTab2 === "customer-centric-approach" && (
            <p className="text-gray-700">
              ...
              closely with landscape designers, architects, and developers to
              meet their unique requirements. Whether you need plants for
              residential, commercial, or public projects, we provide tailored
              solutions that align with your vision and specifications.
            </p>
          )}
          {activeTab2 === "sustainable-practices" && (
            <p className="text-gray-700">
              Sustainability is a core value at Welcome to STAR BLOOM
              LANDSCAPING & AGRICULTURAL SERVICES, SP LLC.We employ
          ...
          {activeTab2 === "global-reach" && (
            <p className="text-gray-700">
              ...
              timely and reliable delivery of our plants to various
              destinations, maintaining the highest standards of service and
              quality.
            </p>
          )}
        </div>
